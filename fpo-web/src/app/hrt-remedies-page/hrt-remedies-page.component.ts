...
@Component({
  selector: "app-hrt-remedies-page",
  templateUrl: "./hrt-remedies-page.component.html",
  styleUrls: ["./hrt-remedies-page.component.scss"],
})
export class HrtRemediesPageComponent implements OnInit, OnDestroy {
